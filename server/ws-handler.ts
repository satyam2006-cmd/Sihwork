...
/**
 * Registers the connection handler and heartbeat on the given WebSocketServer.
 * This is shared between the standalone dev server and the production HTTP server.
 */
